...
// Helper function to safely format a value with toFixed
...
// Helper function for tooltips to safely format values
const safeToFixed = (value: any, prefix: string = ''): string => {
  if (typeof value === 'number') {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-12">
        ...
        <div className="h-96" style={{ width: '100%', height: '400px' }}>
          <ResponsiveContainer width="100%" height="100%" minHeight={300}>
            ...
            >
              ...
              <Tooltip formatter={(value) => [safeToFixed(value), 'Average Cost']} />
            ...
            >
              ...
              <Tooltip cursor={{ strokeDasharray: '3 3' }} 
                       formatter={(value, name) => {
                         if (name === 'Median Cost' || name === 'Mean Cost') return [safeToFixed(value), name];
        ...
        <div className="h-96">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <XAxis dataKey="name" />
              <YAxis label={{ value: 'Cost ($/ton)', angle: -90, position: 'insideLeft' }} />
              <Tooltip formatter={(value) => [safeToFixed(value), 'Cost']} />
              <Legend />
        ...
        <div className="h-96">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip cursor={{ strokeDasharray: '3 3' }} 
                       formatter={(value, name) => {
                         if (name === 'Cost Balance') return [safeToFixed(value), name];
        ...
        <div className="h-96">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip 
                formatter={(value, name) => {
                  if (name === 'meanCost') return [safeToFixed(value), 'Mean Cost'];
                  if (name === 'ratio') return [safeToFixed(value), 'Mean/Median Ratio'];
                  return [value, name];
                }} 
              />
              <Legend />
        ...
        <div className="h-96">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <XAxis dataKey="name" />
              <YAxis label={{ value: 'Cost ($/ton)', angle: -90, position: 'insideLeft' }} />
              <Tooltip formatter={(value) => [safeToFixed(value), 'Average Cost']} labelFormatter={(value) => `Volume: ${flowVolumeData.find(d => d.name === value)?.volume}`} />
              <Legend />
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip formatter={(value, name) => {
                if (name === 'cost') return [safeToFixed(value), 'Average Cost'];
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip cursor={{ strokeDasharray: '3 3' }} formatter={(value, name) => {
                if (name === 'z') return [safeToFixed(value), 'Cost per ton'];
                return [value, name];
              }} />
